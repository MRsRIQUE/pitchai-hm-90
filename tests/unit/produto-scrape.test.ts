...
/**
 * Contrato da leitura da página do produto (extension/product-scrape.js).
 *
 * O arquivo roda injetado numa aba do TikTok, onde não há como testar: aqui ele
 * é executado contra um DOM de mentira, com as três origens de dado que a
 * página usa — JSON-LD, meta tags e o DOM cru. Se o TikTok mudar e a gente
 * ajustar a heurística, é este teste que segura o ajuste no lugar.
 */
...
describe("leitura da página do produto", () => {
  ...
  it("no DOM cru, pega o h1, a maior foto de CDN e o primeiro preço do texto", () => {
    const lido = ler({
