...
export function UsuariosTab() {
  ...
  // Espelha as regras do servidor para o botão só liberar o que a API aceita.
  ...
  const grantM = useMutation({
    // `plan` faltava aqui: a API aceitava trimestral/anual desde ec0d0e3, mas o
    // painel nunca enviava o campo e toda cortesia caía no default trimestral.
    ...
    onSuccess: (res: any) => {
      ...
      setMsg({ kind: "ok", text: `Cortesia ${planName} de ${days} dias liberada para ${email}` });
      setEmail("");
      setNote("");
          ...
          <section className="rounded-2xl border border-white/10 bg-white/5 p-5 space-y-4">
            <div>
              ...
              <p className="text-xs text-white/50 mt-1">
                ...
                de clientes. Máximo de {COURTESY_MAX_DAYS} dias por concessão — para estender,
                conceda de novo no vencimento.
              </p>
            </div>
