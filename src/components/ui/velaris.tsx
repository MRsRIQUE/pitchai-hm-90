...
/**
 * Velaris — fundo animado em WebGL: simplex noise em camadas, mistura de
 * cores, vinheta e grão de filme.
 *
 * Diferenças em relação ao snippet original: as cores são convertidas uma vez
 * (e não a cada frame), o efeito congela num quadro estático quando o usuário
 * pede menos movimento e o loop pausa enquanto o bloco está fora da tela —
 * ele vive no rodapé da landing, então rodaria à toa o tempo todo.
 */
...
export function Velaris({
  ...
  // as cores só mudam de identidade quando os valores mudam de fato
  ...
  useEffect(() => {
    ...
    if (reduced) {
      // um único quadro: o gradiente aparece, mas parado
      draw(0);
